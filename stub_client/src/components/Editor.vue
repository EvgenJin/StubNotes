<template>
  <div class="editor">
      <div v-if="!disabled" class="editor-toolbar">
        ...
        <v-btn small icon @click="table" title="Insert Table"><v-icon>table_chart</v-icon></v-btn>
        ...
        <!-- <a class="btn btn--icon btn--small" style="float:right" title="formatting help" target="_blank" href="http://localhost:8080"> -->
